<?php
  ...
  */
  ...
  $strCourseNumber = "GSP 538";
  $strCourseSemester = "Fall 2017";
  $strLectureNumber = "1";
  $strLectureTitle = "Sampling";
  $strDate = "Week 1";
  $strTest = "Midterm";
  $strPNGpath = "1_Sampling";
  $strPNGpattern = "Lecture01ppt_Page_";
  $strPNGextension = ".png";
...
<table id="slideset" name="slideset" width="95%" height="330" border="1" style='border:1px blue solid;'>
  <tr>
    ...
    <td width="463" id="courseBox" name="courseBox">
      <h2 style="text-decoration:underline;">
        <?php echo $strCourseNumber; ?>&nbsp;<?php echo $strCourseSemester; ?>
      </h2>
    </td>
  ...
  <tr>
    ...
    <th id="relatedLinksNav" name="relatedLinksNav" align="center">
      <a href="1_Sampling.pdf" target="_blank">PDF file</a>&nbsp;| &nbsp;
    </th>
  </tr>
  <tr>
